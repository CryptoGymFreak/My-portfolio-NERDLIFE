...
<section id="work" class="container mx-auto my-8">
    ...
    <div class="flex flex-wrap lg:gap-4">
      ...
      <div class="w-full md:w-1/2 lg:w-1/4 smaller-gaps relative">
        ...
        <a href="#" class="block relative group">
          ...
          <div class="absolute bottom-0 left-0 right-0 p-4 bg-gray-800 bg-opacity-50 text-white group-hover:bg-opacity-75 transition-all duration-300">
            <h3 class="font-bold">Application 1</h3>
      ...
      <div class="w-full md:w-1/2 lg:w-1/4 smaller-gaps">
        <a href="#" class="block relative group">
          <img src="https://via.placeholder.com/400x300" alt="Application 2" class="rounded-lg object-cover h-64 w-full">
          <div class="absolute bottom-0 left-0 right-0 p-4 bg-gray-800 bg-opacity-50 text-white group-hover:bg-opacity-75 transition-all duration-300">
            <h3 class="font-bold">Application 2</h3>
            <p class="text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
          </div>
        </a>
      </div>
...
<section id="contact" class="container mx-auto my-8">
    ...
    <p class="text-gray-600">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam consequat nisi sit amet ante convallis vulputate.</p>
